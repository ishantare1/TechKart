<%-- 
    Document   : cart
    Created on : 22-Jan-2024, 5:08:37 pm
    Author     : Admin
--%>
...
<html>
  ...
  <tbody>
      ...
      <%
       ...
       %>
       <tr>
           <th scope="row"><%=c.getDeviceName()%></th>
           <td>&#x20B9;<%=c.getPrice()%></td>
           <td>
               <a href="remove_device?did=<%=c.getDid()%>&&uid=<%=c.getUserId()%>&&cid=<%=c.getCid()%>" class="btn btn-sm btn-danger">Remove</a>
           </td>
